...
<div class="dropdown">
<a href="aboutus-workout-club.php" style=" text-decoration:none;"><button class="dropbtn"> 
ABOUT
</button></a>
</div>

<div class="dropdown">
  <a href="schedule-fitness-body.php" style=" text-decoration:none;"><button class="dropbtn"> 
SCHEDULE
</button></a>
</div>
